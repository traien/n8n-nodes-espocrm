...
export const attachmentFields: INodeProperties[] = [
		...
		options: [
			{
				name: 'Binary Field',
				value: 'binaryField',
				description: 'Upload from a binary property on the input item',
			},
			{
				name: 'Base64 Direct',
				value: 'base64Direct',
				description: 'Provide base64-encoded file content directly',
			},
		],
		default: 'binaryField',
	...
	// Binary Field option
	{
		...
		displayOptions: {
			show: { resource: ['attachment'], operation: ['upload'], inputSource: ['binaryField'] },
		},
		required: true,
	},
	// Binary Property (Download)
	{
		displayName: 'Binary Property',
		name: 'binaryPropertyName',
		type: 'string',
	...
	// Base64 Direct options
	{
		...
		displayOptions: {
			show: { resource: ['attachment'], operation: ['upload'], inputSource: ['base64Direct'] },
		},
		required: true,
	},
	{
	...
	},
	{
		...
		default: '',
		description:
			'MIME type of the file (e.g., application/pdf). If not provided, will be auto-detected from file extension.',
		displayOptions: {
			show: { resource: ['attachment'], operation: ['upload'], inputSource: ['base64Direct'] },
		},
	},
	...
	// Common ID field for get/delete
	{
		...
		displayOptions: {
			show: { resource: ['attachment'], operation: ['get', 'delete', 'download'] },
		},
	},
];
